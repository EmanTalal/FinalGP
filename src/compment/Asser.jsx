...
import { FaCloud, FaMountainSun } from "react-icons/fa6";
...
const Asser = () => {
  const AsserPosition = [18.2167, 42.5];
      ...
      <div className="bg-white h-[100vh]">
        <div className="bg-white w-full flex flex-col  justify-center">
          ...
          <div className="flex flex-col items-start px-20 mt-10  mb-10 ">
            ...
            <p>
              Aseer, the cultural heart of Saudi, offers diverse attractions in
              Abha. Explore Shada Palace, Abha Dam Lake, and Abha Palace Theme
              Park. Hike Aseer National Park near Souda Mountain and visit
              Waterfall Park and Abu Kheyal Park. Enjoy Abha’s cable cars, the
              Aseer Regional Museum, Al Muftaha art village, and local tribal
              customs in Al Habala and Rijal Almaa.
            </p>
          ...
          <h1 className=" px-20 text-black text-xl md:text-5xl font-bold mt-36 mb-6 tracking-wide">
            Things to Do in Aseer
          </h1>
          <div className="px-20 mb-6   grid grid-cols-1 md:flex mt-7 flex-row gap-3 ">
          ...
          <div className=" grid grid-cols-1 md:flex flex-row justify-around w-[120%] md:w-full h-[100vh] px-20 mb-96 md:mb-0">
                ...
                <div className="flex flex-col ">
                  <div className=" grid grid-cols-1 md:flex flex-row items-center gap-3">
                    <img
                      ...
                      src="https://scth.scene7.com/is/image/scth/alareesh-new-banner:crop-1920x1080?defaultImage=alareesh-new-banner&wid=1920&hei=1080"
                    />
                    <div className="flex flex-col">
                      <div className="flex flex-row gap-1 items-center text-black ">
                        <CiLocationOn className="text-[#F97316]" />
                        <h1 className="font-bold text-sm">Aseer</h1>
                        <div className="text-gray-400">l</div>
                        <h1 className="font-bold text-sm">Food & Beverages</h1>
                      </div>
                      <h1 className="text-2xl font-bold">Al Areesh</h1>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col ">
                  <div className=" grid grid-cols-1 md:flex flex-row items-center gap-3">
                    <img
                      ...
                      src="https://scth.scene7.com/is/image/scth/albasta-district-article:crop-1920x1080?defaultImage=albasta-district-article&wid=1920&hei=1080"
                    />
                    <div className="flex flex-col ">
                      <div className="flex flex-row gap-1 items-center text-black ">
                        <CiLocationOn className="text-[#F97316]" />
                      ...
                      <h1 className="text-2xl font-bold">Al Basta District</h1>
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex flex-row items-start  w-[95%] duration-300 ease-in-out hover:bg-white h-[100vh ]  hover:border-2 hover:border-gray-100  rounded-lg hover:shadow-xl ">
                <div className="flex flex-col ">
                  <div className=" grid grid-cols-1 md:flex flex-row items-center gap-3">
                    <img
                      className="w-64 h-42 rounded-lg"
                      src="https://scth.scene7.com/is/image/scth/cable-car-adventure-abha:crop-1920x1080?defaultImage=cable-car-adventure-abha&wid=1920&hei=1080"
                    />
                    <div className="flex flex-col">
                      <div className="flex flex-row gap-1 items-center text-black ">
                        <CiLocationOn className="text-[#F97316]" />
                      ...
                      <h1 className="text-2xl font-bold">Al Habala Park</h1>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3862437.5312556378!2d38.06882823572458!3d19.023614353708975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e0170a439633013%3A0x9b1f03b6118c1c1b!2sAseer%20Province%20Saudi%20Arabia!5e0!3m2!1sen!2seg!4v1721650317740!5m2!1sen!2seg"
              width="600"
              height="450"
          ...
          <div className="flex flex-col h-[90vh] mb-72 md:mb-0 md:mt-0">
            <h1 className="text-black text-xl  md:text-5xl font-bold  mb-6 tracking-wide px-20">
              Complete Guide to Aseer
            </h1>
